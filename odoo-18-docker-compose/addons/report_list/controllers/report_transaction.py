            ...
            if inline_search:
                ...
                for key, value in inline_search.items():
                    ...
                    if key == 'order_type':
                        ...
                        if normalized in ('mua', 'buy', 'purchase'):
                            domain.append(('transaction_type', 'in', ['buy', 'purchase']))
                            continue
                        if normalized in ('ban', 'bán', 'sell', 'sale'):
                            domain.append(('transaction_type', 'in', ['sell', 'sale']))
                            continue
