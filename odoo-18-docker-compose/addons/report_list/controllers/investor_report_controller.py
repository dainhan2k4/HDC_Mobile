...
class InvestorReportController(http.Controller):
    ...
    def get_investor_report_data(self, filters, page, limit, search_values=None, **kws):
        ...
        try:
            ...
            records = request.env['investor.list'].sudo().search(domain, limit=int(limit), offset=offset)
            total_records = request.env['investor.list'].sudo().search_count(domain)
    ...
    def export_pdf(self, **kw):
        ...
        try:
            ...
            records = request.env['investor.list'].sudo().search(domain)
