        ...
        try:
            ...
            for index, row in df.iterrows():
                try:
                    ...
                    transaction_type_map = {
                        'mua': 'purchase', 'buy': 'purchase', 'purchase': 'purchase', 'mua_ccq': 'purchase',
                        'bán': 'sell', 'sell': 'sell', 'sale': 'sell', 'bán_ccq': 'sell',
                        'hoán_đổi': 'exchange', 'hoan_doi': 'exchange', 'exchange': 'exchange', 'swap': 'exchange'
                    }
                    transaction_type = transaction_type_map.get(transaction_type_raw, 'purchase')
            ...
            response_data = {
                ...
                "supported_columns": {
                    ...
                    "trade_value": ["trade_value", "giá_trị_mua_bán", "gia_tri_mua_ban", "purchase_sell_value"],
