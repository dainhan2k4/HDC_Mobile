          ...
          <div class="card-body p-0">
            <table class="table table-hover mb-0">
                <thead class="table-light">
                    <tr>
                        <th class="px-3 py-2 text-uppercase small text-muted">Tên phường/xã</th>
                        <th class="px-3 py-2 text-uppercase small text-muted">Mã phường/xã</th>
                        <th class="px-3 py-2 text-uppercase small text-muted">Thành phố</th>
                ...
                <tbody>
                    ...
                    <t t-foreach="state.wards" t-as="ward" t-key="ward.id">
                        <tr class="align-middle">
                            <td class="px-3 py-2 fw-bold" t-esc="ward.name"/>
                            <td class="px-3 py-2 text-muted" t-esc="ward.code"/>
                            <td class="px-3 py-2" t-esc="ward.city_name"/>
                            <td class="px-3 py-2">
                                <span t-if="ward.active" class="badge rounded-pill bg-success-subtle text-success-emphasis p-2">
                                    Kích hoạt
                                </span>
                            ...
                            <td class="px-3 py-2 text-center">
                                <a href="#" t-on-click.prevent="() => this.handleEdit(ward.id)" class="btn btn-sm btn-link text-primary text-decoration-none">
                                    <i class="fas fa-pencil-alt fa-lg"></i>
                                </a>
                                <a href="#" t-on-click.prevent="() => this.handleDelete(ward.id)" class="btn btn-sm btn-link text-danger text-decoration-none">
