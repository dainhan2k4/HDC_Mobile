            ...
            return request.make_response(
                json.dumps({
                    ...
                    'balance': {
                        ...
                        'last_sync': balance.last_sync.strftime('%Y-%m-%d %H:%M:%S') if balance.last_sync else '',
