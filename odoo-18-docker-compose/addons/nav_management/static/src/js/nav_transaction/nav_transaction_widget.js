...
export class NavTransactionWidget extends Component {
      ...
      <div class="container-fluid">
        ...
        <div class="nav-management-content-header mb-3">
          <div class="d-flex gap-2 flex-wrap">
            <button t-att-class="'nav-management-btn-modern ' + (state.currentTab==='nav' ? 'nav-management-btn-primary-modern' : 'nav-management-btn-secondary-modern')" style="--btn-bg:#f97316;--btn-hover:#fb923c;--btn-border:#f97316;--btn-color:#f97316" t-on-click="() => this.switchTab('nav')">
              <i class="fas fa-table me-2"></i>Danh sách NAV phiên giao dịch
            </button>
            <button t-att-class="'nav-management-btn-modern ' + (state.currentTab==='mm' ? 'nav-management-btn-primary-modern' : 'nav-management-btn-secondary-modern')" style="--btn-bg:#f97316;--btn-hover:#fb923c;--btn-border:#f97316;--btn-color:#f97316" t-on-click="() => this.switchTab('mm')">
        ...
        <div class="main-content">
            ...
            <div class="row align-items-center">
              ...
              <div class="col-lg-6">
                <div class="d-flex gap-2 justify-content-end flex-wrap">
                  ...
                  <button t-if="state.showCalculatedResults" class="nav-management-btn-modern nav-management-btn-secondary-modern me-2" style="--btn-border:#f97316;--btn-color:#f97316" t-on-click="showOriginalData" t-on-mousedown="(ev) => ev.target.classList.add('active')" t-on-mouseup="(ev) => ev.target.classList.remove('active')" t-on-mouseleave="(ev) => ev.target.classList.remove('active')">
              ...
              <div class="card-body">
                <div class="row">
                  ...
                  <div class="col-md-4">
                    ...
                    <input type="date" id="singleDateFilter" class="nav-management-form-control" t-on-change="onSingleDateFilterChange"/>
                  </div>
                  <div class="col-md-4">
                    <label for="quickDateFilter" class="nav-management-form-label">Xem nhanh:</label>
                    <select id="quickDateFilter" class="nav-management-form-select" t-on-change="onQuickDateFilterChange">
            ...
            <table class="nav-management-modern-table compact">
              <thead>
                <tr>
                  ...
                  <th scope="col" style="text-align: center;">Nhà đầu tư</th>
                  <th scope="col" style="text-align: center;">Loại lệnh</th>
                  <th scope="col" style="text-align: center;">Ngày mua/bán</th>
                  <th scope="col" style="text-align: center;">Ngày đáo hạn</th>
                  <th scope="col" style="text-align: center;">Số ngày</th>
                  <th scope="col" style="text-align: center;">Kỳ hạn (tháng)</th>
                  <th scope="col" style="text-align: center;">Số lượng CCQ</th>
                  <th scope="col" style="text-align: center;">Giá NAV</th>
                  <th scope="col" style="text-align: center;">Lãi suất</th>
                  <th scope="col" style="text-align: center;">LS quy đổi (giá bán 2)</th>
                  <th scope="col" style="text-align: center;">Chênh lệch LS</th>
                  <th scope="col" style="text-align: center;">Giá trị lệnh</th>
                  <th scope="col" style="text-align: center;">Giá trị mua/bán</th>
                  <th scope="col" style="text-align: center;">Giá mua/bán 1</th>
                  <th scope="col" style="text-align: center;">Giá mua/bán 2</th>
                </tr>
                <tr class="nav-management-filter-row">
                  <th style="text-align: center;">
                    <div style="display: flex; flex-direction: column; align-items: center; gap: 5px;">
                      ...
                      <small style="font-size: 10px;">Tất cả</small>
                    </div>
                  </th>
                  <th></th>
                  <th><input type="text" class="nav-management-filter-input" placeholder="Tìm nhà đầu tư..." t-on-input="(ev) => this.filterTable('investor_name', ev.target.value)" /></th>
                  <th></th>
                  <th></th>
                  <th></th>
                  <th></th>
                  <th>
                    <select class="nav-management-form-select" t-on-change="onTermFilterChange">
                      <option value="">Tất cả</option>
                      <option value="1" t-att-selected="this.isSelectedTerm(1)"><t t-esc="this.formatMonthWithRate(1)"/></option>
                      <option value="2" t-att-selected="this.isSelectedTerm(2)"><t t-esc="this.formatMonthWithRate(2)"/></option>
                      <option value="3" t-att-selected="this.isSelectedTerm(3)"><t t-esc="this.formatMonthWithRate(3)"/></option>
                      <option value="4" t-att-selected="this.isSelectedTerm(4)"><t t-esc="this.formatMonthWithRate(4)"/></option>
                      <option value="5" t-att-selected="this.isSelectedTerm(5)"><t t-esc="this.formatMonthWithRate(5)"/></option>
                      <option value="6" t-att-selected="this.isSelectedTerm(6)"><t t-esc="this.formatMonthWithRate(6)"/></option>
                      <option value="7" t-att-selected="this.isSelectedTerm(7)"><t t-esc="this.formatMonthWithRate(7)"/></option>
                      <option value="8" t-att-selected="this.isSelectedTerm(8)"><t t-esc="this.formatMonthWithRate(8)"/></option>
                      <option value="9" t-att-selected="this.isSelectedTerm(9)"><t t-esc="this.formatMonthWithRate(9)"/></option>
                      <option value="10" t-att-selected="this.isSelectedTerm(10)"><t t-esc="this.formatMonthWithRate(10)"/></option>
                      <option value="11" t-att-selected="this.isSelectedTerm(11)"><t t-esc="this.formatMonthWithRate(11)"/></option>
                      <option value="12" t-att-selected="this.isSelectedTerm(12)"><t t-esc="this.formatMonthWithRate(12)"/></option>
                    </select>
                  </th>
                  <th><input type="number" class="nav-management-filter-input" placeholder="Số lượng CCQ" t-on-input="(ev) => this.filterTable('units', ev.target.value)" /></th>
                  <th><input type="number" class="nav-management-filter-input" placeholder="Giá NAV" t-on-input="(ev) => this.filterTable('nav_value', ev.target.value)" /></th>
                  <th></th>
                  <th></th>
                  <th></th>
                  <th></th>
                  <th></th>
                  <th style="text-align: center;">
                    <button t-if="state.navCalculated" class="btn btn-sm" style="background: #f97316; color: white; border: none; padding: 5px 10px; border-radius: 4px; font-size: 12px;" t-att-disabled="this.getSelectedCount()===0" t-on-click="() => this.handleMmBulkAction()">
                      Buy/Sell (<t t-esc="this.getSelectedCount()"/>)
                    </button>
                  </th>
                </tr>
              </thead>
              <tbody>
                ...
                <t t-elif="(state.showCalculatedResults ? state.calculatedTransactions : state.filteredTransactions) and (state.showCalculatedResults ? state.calculatedTransactions : state.filteredTransactions).length > 0">
                  <t t-foreach="(state.showCalculatedResults ? state.calculatedTransactions : state.filteredTransactions).slice(state.startIndex, state.endIndex)" t-as="transaction" t-key="transaction.id">
                    <tr>
                      <td style="text-align: center;"><input type="checkbox" t-att-checked="this.isSelected(transaction.id)" t-on-change="(ev) => this.toggleSelect(transaction, ev.target.checked)"/></td>
                      <td style="text-align: center;"><t t-esc="state.startIndex + transaction_index + 1"/></td>
                      <td><t t-esc="this.getDisplayValue(transaction.investor_name)"/></td>
                      <td>
                      ...
                      <td><t t-esc="this.formatCurrency(transaction.nav_value)"/></td>
                      <td><t t-esc="this.formatPercent(transaction.interest_rate)"/></td>
                      <td><t t-esc="this.formatPercentFixed2(transaction.interest_rate_new)"/></td>
                      <td>
                        <t t-if="transaction.interest_delta===0 || transaction.interest_delta">
                          <span t-att-class="'badge-chip ' + this.getDeltaBadgeClass(transaction.interest_delta)"><t t-esc="this.formatDeltaPercent(transaction.interest_delta)"/></span>
                        </t>
                        <t t-else="">-</t>
                      </td>
                      <td><t t-esc="this.formatCurrency(transaction.trade_price || 0)"/></td>
                      <td><t t-esc="this.formatCurrency(transaction.sell_value || 0)"/></td>
                      <td><t t-esc="this.formatCurrency(transaction.price1 || 0)"/></td>
                      <td><t t-esc="this.formatCurrency(transaction.price2 || 0)"/></td>
                  ...
                  <tr>
                    <td colspan="17" class="text-center py-5">
                      <div class="nav-management-empty-state">
                        <i class="fas fa-chart-line nav-management-empty-state-icon"></i>
                        <h3 class="nav-management-empty-state-title">Không có dữ liệu</h3>
                        <p class="nav-management-empty-state-description">Vui lòng chọn quỹ và điều kiện lọc để xem dữ liệu NAV phiên giao dịch.</p>
                      </div>
                    </td>
                  </tr>
                </t>
          ...
          <div class="nav-management-content-header mt-4">
            <div class="d-flex justify-content-between align-items-center">
              ...
              <div class="d-flex gap-2">
                <button class="nav-management-btn-modern nav-management-btn-primary-modern" style="--btn-bg:#f97316;--btn-hover:#fb923c" t-on-click="loadMatchedOrders">
          ...
          <div class="matched-orders-container">
            ...
            <div class="table-container" style="font-size: 0.85rem;">
              <table class="transaction-table table table-sm table-bordered table-hover" style="margin-bottom: 0;">
                <thead class="table-dark">
                  <tr>
                    <th style="font-size: 0.8rem; font-weight: 600; text-align: center; width: 50px;">
                      <input type="checkbox" t-on-change="(ev) => this.toggleSelectAllMatchedOrders(ev.target.checked)" title="Chọn tất cả"/>
                    </th>
                    <th style="font-size: 0.8rem; font-weight: 600;">STT</th>
                    <th style="font-size: 0.8rem; font-weight: 600;">Người mua</th>
                    <th style="font-size: 0.8rem; font-weight: 600;">Người bán</th>
                    <th style="font-size: 0.8rem; font-weight: 600;">Giá</th>
                    <th style="font-size: 0.8rem; font-weight: 600;">Số CCQ</th>
                    <th style="font-size: 0.8rem; font-weight: 600;">Giá trị lệnh</th>
                    <th style="font-size: 0.8rem; font-weight: 600;">Lãi suất</th>
                    <th style="font-size: 0.8rem; font-weight: 600;">Kỳ hạn</th>
                    <th style="font-size: 0.8rem; font-weight: 600;">Phiên giao dịch</th>
                    <th style="font-size: 0.8rem; font-weight: 600;">Thao tác</th>
                </tr>
              </thead>
              <tbody>
                    ...
                    <tr>
                      <td colspan="11" class="text-center py-4">
                        <div class="nav-management-error-state">
                          ...
                          <button class="nav-management-btn nav-management-btn-primary mt-3" style="background-color:#f97316;border-color:#f97316" t-on-click="loadMatchedOrders">
                            <i class="fas fa-refresh me-2"></i>Thử lại
                          </button>
                        </div>
                      </td>
  ...
  validateSelectedTransactionsForMM() {
    ...
    const validTx = selected.filter(tx => {
      ...
      return type === 'purchase' || type === 'sell';
    });
    ...
    return { 
      ...
      data: {
        ...
        buys: validRemaining.filter(tx => tx.transaction_type.toLowerCase() === 'purchase'),
  ...
  applyFiltersToMatchedOrders() {
    ...
    this.state.matchedOrdersPagination.totalItems = data.length;
    this.state.matchedOrdersPagination.currentPage = 1;
    this.state.displayedMatchedOrders = data.slice(0, this.state.matchedOrdersPagination.itemsPerPage);
  }
  ...
  updateMatchedOrdersDisplay() {
    ...
    this.state.displayedMatchedOrders = this.state.matchedOrders.slice(startIndex, endIndex);
  }
  ...
  getTypeLabel(tx) {
    ...
    if (t === 'purchase') return 'Mua';
    if (t === 'sell') return 'Bán';
    if (t === 'exchange') return 'Chuyển đổi';
    // Một số nguồn có thể dùng 'buy' thay vì 'purchase'
    if (t === 'buy') return 'Mua';
    return 'Khác';
  }
  ...
  getTypeBadgeClass(tx) {
    const t = (tx && tx.transaction_type ? tx.transaction_type : '').toLowerCase();
    if (t === 'purchase' || t === 'buy') return 'badge-type-buy';
