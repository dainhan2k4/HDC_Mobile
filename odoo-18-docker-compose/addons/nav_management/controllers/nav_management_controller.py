...
class NavManagementController(http.Controller):
    ...
    @http.route('/nav_management/api/funds', type='json', auth='public', methods=['POST'])
    def get_funds(self):
    ...
    @http.route('/nav_management/api/nav_transaction', type='json', auth='public', methods=['POST'])
    def get_nav_transactions(self, fund_id=None, from_date=None, to_date=None, status_filter='pending'):
        ...
        try:
            ...
            print(f"Error in get_nav_transactions: {str(e)}")
            import traceback
            traceback.print_exc()
            return {'error': str(e)}
    
    @http.route('/nav_management/api/nav_monthly', type='json', auth='public', methods=['POST'])
    ...
    @http.route('/nav_management/api/nav_monthly', type='json', auth='public', methods=['POST'])
    def create_nav_monthly(self, fund_id, period, nav_beginning, nav_ending, description=''):
    ...
    @http.route('/nav_management/api/nav_monthly/<int:nav_id>', type='json', auth='public', methods=['PUT'])
    ...
    @http.route('/nav_management/api/nav_monthly/<int:nav_id>', type='json', auth='public', methods=['DELETE'])
    ...
    @http.route('/nav_management/api/term_rates', type='http', auth='public', methods=['GET'], csrf=False)
    ...
    @http.route('/nav_management/api/calc_metrics', type='json', auth='public', methods=['POST'])
    ...
    @http.route('/nav_management/api/cap_config', type='http', auth='public', methods=['GET'], csrf=False)
    ...
    @http.route('/nav_management/api/calculate_nav_transaction', type='json', auth='public', methods=['POST'])
    ...
    @http.route('/nav_management/api/calculate_nav_monthly', type='json', auth='public', methods=['POST'])
    ...
    @http.route('/nav_management/api/daily_inventory', type='json', auth='public', methods=['POST'])
    ...
    @http.route('/nav_management/api/recalculate_inventory', type='json', auth='public', methods=['POST'])
    ...
    @http.route('/nav_management/api/refresh_all_inventories', type='json', auth='public', methods=['POST'])
    ...
    @http.route('/nav_management/api/daily_inventory', type='json', auth='public', methods=['PUT'])
    ...
    @http.route('/nav_management/api/daily_inventory/auto_create', type='json', auth='public', methods=['POST'])
    ...
    @http.route('/nav_management/api/inventory/recalc_after_match', type='json', auth='public', methods=['POST'])
    ...
    @http.route('/nav_management/api/inventory/confirm_end_of_day', type='json', auth='public', methods=['POST'])
    ...
    @http.route('/nav_management/api/opening_price_today_http', type='http', auth='public', methods=['GET'], csrf=False)
