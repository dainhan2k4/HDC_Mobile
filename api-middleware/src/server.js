...
app.use(`${config.server.apiPrefix}/payment`, paymentRoutes); // No caching for payment
console.log(`✅ [Server] Payment routes registered at ${config.server.apiPrefix}/payment`);
